...
export default function CollectorWithdrawalAddCard({navigation}) {
  ...
  return (
    <View style={styles.container}>
      <ScrollView>
        <View>
          ...
          <View>
            ...
            <TouchableOpacity 
              onPress={() => navigation.navigate("WithdrawalAddCardInfo")}
      ...
      <View style={styles.btnFooter}>
        <Text
          onPress={isEnabled ? () => navigation.navigate("WithdrawalCollectorConfirmPayment") : null}
