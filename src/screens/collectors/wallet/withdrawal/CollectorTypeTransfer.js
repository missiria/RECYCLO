...
const CollectorTypeTransfer = ({ navigation, route }) => {
  ...
  const toggleSwitchTree = () =>
    setIsEnabledTree((previousState) => !previousState);
    ...
    <View style={styles.container}>
      <ScrollView>
        <View style={{ marginHorizontal: 20, marginTop: 22 }}>
          ...
          <View>
            <Text style={{ color: "#262626", marginTop: 30, fontSize: 14 }}>
              Je retire l'argent via mon compte bancaire
            </Text>
            <View style={styles.boxVers}>
              <View style={styles.topOfBox}>
                <Text style={{ fontWeight: "bold" }}>
                  Retrait via compte bancaire
                </Text>
                <Switch
                  trackColor={{ false: "#767577", true: "#B3FFCA" }}
              ...
              <View style={{ flexDirection: "row", alignItems: "center" }}>
                <Image style={styles.imgProfile} source={bankType} />
              </View>
            </View>
          </View>
          ...
          {/* <View>
            <Text style={{ color: "#262626", marginTop: 30, fontSize: 14 }}>
              Pas de compte bancaire? je retire via guichet bancaire
            </Text>
            <View style={styles.boxVers}>
              <View style={styles.topOfBox}>
              ...
              <View>
                <Text style={{ marginBottom: 10 }}>
                  Vous recevez un code de retrait via SMS
                </Text>
                <Image style={styles.imgProfile} source={bankType} />
              </View>
            </View>
        ...
        <View style={styles.boxBtn}>
          <Text
            onPress={
              isEnabledTwo
                ? () =>
                    navigation.navigate("CollectorWithdrawal", {
                      action,
                      amount,
                    })
                // : isEnabledTree
                // ? () =>
                //     navigation.navigate("DescScreenT", {
                //       action: "ATM",
                //       amount,
                //     })
                : null
...
export default CollectorTypeTransfer;
