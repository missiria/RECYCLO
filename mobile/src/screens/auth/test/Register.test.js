...
test("Return object of fields with values when form is valid", async () => {
    let user = { first_name: 'amine', email : 'amine@gmail.com', last_name: 'amazzal', phone:'0691987003',password:'amineamazzal' }
...
test("Return Error When Password Is less than 8 characters", async () => {
    let user = { first_name: 'amine', last_name: 'amazzal', phone:'0691987003', password:'ab1' }
...
test("Return Error When Phone Is Not Number", async () => {
    let user = { first_name: 'amine', last_name: 'amazzal',phone:'lol',password:'jfjfjfjfjf' }
