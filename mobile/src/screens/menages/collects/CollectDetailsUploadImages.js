...
export default function CollectDetailsUploadImages({ navigation, route }) {
  ...
  const { dateDeclary, timeDeclary, quantityDeclary, priceDeclary, collectId } =
    route.params;
  ...
  return (
    <View style={styles.container}>
      <ScrollView>
        <View>
          <View style={styles.boxCard}>
            ...
            >
              <Image style={styles.imageStyle} source={uploadIcon} />
            </TouchableOpacity>
            {images &&
              images.map((image) => (
                <Image
      ...
      <View style={styles.btnBoxDec}>
        <Text onPress={onSubmit} style={styles.btnDeclar}>
      ...
      >
        <View style={styles.modal}>
          <View style={styles.modalView}>
            <Image style={styles.cameraBigimageStyle} source={camUp} />
            ...
            <View style={styles.btnBox}>
              ...
              >
                ...
                <Image style={styles.iconOfBtnOfUpload} source={camera} />
              </TouchableOpacity>
              <TouchableOpacity
                onPress={pickImage}
                style={styles.btnUploadImage}
              >
                ...
                <Image style={styles.iconOfBtnOfUpload} source={gallery} />
              </TouchableOpacity>
            </View>
            <TouchableOpacity
              onPress={() => {
