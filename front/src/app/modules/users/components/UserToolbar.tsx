...
export function UserToolbar() {
  return (
    <div className='card-toolbar d-flex align-items-center'>
      <form action='/accounts' className='ms-3'>
              ...
              <li className='dropdown-submenu'>
                ...
                <div className='mb-3'>
                  ...
                  <div
                    ...
                    data-kt-compte-table-filter='account_type'
                  >
                    <label
                      htmlFor='all'
      ...
      <div className='actions ms-2 d-flex align-items-center pe-2'>
        <a
          ...
          data-bs-target='#modal_create_user'
        >
          <EDGE_SVG path='/media/icons/duotune/arrows/arr075.svg' className='svg-icon-2' />
          Nouveau utilisateur
        </a>
      </div>
    </div>
