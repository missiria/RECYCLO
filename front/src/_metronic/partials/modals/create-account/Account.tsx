...
const Account: FC = () => {
  ...
  const [currentSchema, setCurrentSchema] = useState(createAccountSchema[0])
  ...
  const prevStep = () => {
    ...
    setCurrentSchema(createAccountSchema[stepper.current.currentStepIndex - 1])
  }
  ...
  const submitStep = (values: ICreateAccount, actions: FormikValues) => {
    ...
    setCurrentSchema(createAccountSchema[stepper.current.currentStepIndex])
  ...
  return (
    <div className='modal fade' id='kt_modal_create_account' aria-hidden='true'>
          ...
          <div className='modal-body py-lg-10 px-lg-10'>
            ...
            >
              ...
              <div className='flex-row-fluid py-lg-5 px-lg-15'>
                ...
                >
                  {() => (
                    <Form className='form' noValidate id='kt_modal_create_account'>
