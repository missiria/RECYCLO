    ...
    <div className={`card ${className}`}>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bolder fs-3 mb-1'>Statistiques des membres</span>
          <span className='text-muted mt-1 fw-bold fs-7'>Plus de 50 membres</span>
        </h3>
        <div
          ...
          <table className='table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4'>
            ...
            <thead>
              <tr className='fw-bolder text-muted'>
                ...
                <th className='min-w-150px'>Auteures</th>
                <th className='min-w-140px'>Départements</th>
                <th className='min-w-120px'>Progrès</th>
