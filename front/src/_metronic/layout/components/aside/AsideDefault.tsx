...
const AsideDefault: FC = () => {
  ...
  const {aside} = config
  const logo = aside.theme === 'dark' ? '/media/logos/logo_dark.png' : '/media/logos/logo_light.png'
  return (
    <div
      id='kt_aside'
    ...
    >
      ...
      <div className='aside-logo flex-column-auto' id='kt_aside_logo'>
        ...
        <Link to='/dashboard'>
          <div className='logo'>
            <img src={toAbsoluteUrl(logo)} alt='Manager' className='img-fluid' />
          </div>
        </Link>
        {/* end::Logo */}
      ...
      <div className='aside-footer flex-column-auto pt-5 pb-7 px-5' id='kt_aside_footer'>
        ...
        >
          <span className='btn-label'>Documentations</span>
