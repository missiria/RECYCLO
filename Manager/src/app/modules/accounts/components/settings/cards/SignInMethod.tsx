    ...
    <div className='card mb-5 mb-xl-10'>
      ...
      >
        <div className='card-title m-0'>
          <h3 className='fw-bolder m-0'>Méthode de connexion</h3>
        </div>
      </div>
        ...
        <div className='card-body border-top p-9'>
          <div className='d-flex flex-wrap align-items-center'>
            <div id='kt_signin_email' className={' ' + (showEmailForm && 'd-none')}>
              ...
              <div className='fw-bold text-gray-600'>contacts@akhiyat-driver-cars.com</div>
            </div>
          ...
          <div className='notice d-flex bg-light-primary rounded border-primary border border-dashed p-6'>
            ...
            <div className='d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap'>
              <div className='mb-3 mb-md-0 fw-bold'>
                <h4 className='text-gray-800 fw-bolder'>Sécurise le compte</h4>
                <div className='fs-6 text-gray-600 pe-7'>
                  L'authentification à deux facteurs ajoute une couche de sécurité supplémentaire à
                  votre compte. Se connecter en plus, vous devrez fournir un code à 6 chiffres{' '}
                </div>
              </div>
              <a
                href='#'
