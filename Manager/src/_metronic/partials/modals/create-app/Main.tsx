...
const createAppSchema = [
  Yup.object({
    appName: Yup.string().required().label('Nom du compte'),
    category: Yup.string().required().label('Categorie'),
  }),
  Yup.object({
    framework: Yup.string().required().label('Taille'),
  }),
  Yup.object({
    dbName: Yup.string()
      .required()
                ...
                <div className='stepper-nav ps-lg-10'>
                  <div className='stepper-item current' data-kt-stepper-element='nav'>
                    ...
                    <div className='stepper-label'>
                      ...
                      <div className='stepper-desc'>Nom du compte</div>
                    </div>
                  </div>
                  ...
                  <div className='stepper-item' data-kt-stepper-element='nav'>
                    ...
                    <div className='stepper-label'>
                      <h3 className='stepper-title'>Taille</h3>

                      <div className='stepper-desc'>Nombre de vos salaries ?</div>
                    </div>
                  </div>
                  ...
                  <div className='stepper-item' data-kt-stepper-element='nav'>
                    ...
                    <div className='stepper-label'>
                      <h3 className='stepper-title'>Type d'entreprise</h3>
                  ...
                  <div className='stepper-item' data-kt-stepper-element='nav'>
                    ...
                    <div className='stepper-label'>
                      <h3 className='stepper-title'>Facturation</h3>
                      <div className='stepper-desc'>Fournir les détails de paiement</div>
                    </div>
                  </div>
                  ...
                  <div className='stepper-item' data-kt-stepper-element='nav'>
                    ...
                    <div className='stepper-label'>
                      <h3 className='stepper-title'>Libérer</h3>
                    ...
                    <Form className='form' noValidate id='kt_modal_create_app_form'>
                        ...
                        <div className='w-100'>
                          <div className='fv-row mb-10'>
                            <label className='d-flex align-items-center fs-5 fw-bold mb-2'>
                              <span className='required'>Nom du compte</span>
                              <i
                          ...
                          <div className='fv-row'>
                            <label className='d-flex align-items-center fs-5 fw-bold mb-4'>
                              <span className='required'>Secteur d'activité</span>
                              <i
                                className='fas fa-exclamation-circle ms-2 fs-7'
                                data-bs-toggle='tooltip'
                                title="Sélectionnez votre catégorie d'application"
                              ></i>
                            </label>
                            <div className='fv-row'>
                                ...
                                <span className='d-flex align-items-center me-2'>
                                  ...
                                  <span className='d-flex flex-column'>
                                    ...
                                    <span className='fs-7 text-muted'>
                                      Créer une structure de texte claire n'est qu'un SEO
                                    </span>
                                  </span>
                                </span>
                              ...
                              <label className='d-flex flex-stack mb-5 cursor-pointer'>
                                <span className='d-flex align-items-center me-2'>
                                  ...
                                  <span className='d-flex flex-column'>
                                    ...
                                    <span className='fs-7 text-muted'>
                                      Étude de projet, Boite de construction, Usine
                                    </span>
                                  </span>
                                </span>
                                <span className='form-check form-check-custom form-check-solid'>
                              ...
                              <label className='d-flex flex-stack cursor-pointer'>
                                <span className='d-flex align-items-center me-2'>
                                  ...
                                  <span className='d-flex flex-column'>
                                    <span className='fw-bolder fs-6'>Tech et Services</span>
                                    <span className='fs-7 text-muted'>
                                      Agence web, Boite de com, Centre d'appels
                                    </span>
                                  </span>
                                </span>
                                <span className='form-check form-check-custom form-check-solid'>
                      ...
                      <div data-kt-stepper-element='content'>
                        <div className='w-100'>
                          <div className='fv-row'>
                            <label className='d-flex align-items-center fs-5 fw-bold mb-4'>
                              <span className='required'>L'équipe ?</span>
                              <i
                                className='fas fa-exclamation-circle ms-2 fs-7'
                                data-bs-toggle='tooltip'
                                title='Précisez le nombre de votre équipe'
                              ></i>
                            </label>
                            <label className='d-flex flex-stack cursor-pointer mb-5'>
                              <span className='d-flex align-items-center me-2'>
                                ...
                                <span className='d-flex flex-column'>
                                  <span className='fw-bolder fs-6'>1 - 10</span>

                                  <span className='fs-7 text-muted'>TPE (Startup)</span>
                                </span>
                              </span>
                            ...
                            <label className='d-flex flex-stack cursor-pointer mb-5'>
                              <span className='d-flex align-items-center me-2'>
                                ...
                                <span className='d-flex flex-column'>
                                  <span className='fw-bolder fs-6'>10 - 100</span>
                                  <span className='fs-7 text-muted'>
                            ...
                            <label className='d-flex flex-stack cursor-pointer mb-5'>
                              <span className='d-flex align-items-center me-2'>
                                ...
                                <span className='d-flex flex-column'>
                                  <span className='fw-bolder fs-6'>20 - 500</span>
                                  <span className='fs-7 text-muted'>
                            ...
                            <label className='d-flex flex-stack cursor-pointer'>
                              <span className='d-flex align-items-center me-2'>
                                ...
                                <span className='d-flex flex-column'>
                                  <span className='fw-bolder fs-6'>250 - 4999</span>
                                  <span className='fs-7 text-muted'>
                      ...
                      <div data-kt-stepper-element='content'>
                        <div className='w-100'>
                          <div className='fv-row mb-10'>
                            <label className='required fs-5 fw-bold mb-2'>R/C</label>
                          ...
                          <div className='fv-row'>
                            <label className='d-flex align-items-center fs-5 fw-bold mb-4'>
                              <span className='required'>Selectionnez votre type d'entreprise</span>
                            ...
                            <label className='d-flex flex-stack cursor-pointer mb-5'>
                              <span className='d-flex align-items-center me-2'>
                                ...
                                <span className='d-flex flex-column'>
                                  <span className='fw-bolder fs-6'>Entreprise individuelle</span>
                                </span>
                              </span>
                              <span className='form-check form-check-custom form-check-solid'>
                                <Field
                      ...
                      <div data-kt-stepper-element='content'>
                        <div className='w-100 text-center'>
                          <h1 className='fw-bolder text-dark mb-3'>Libérer!</h1>
                          <div className='text-muted fw-bold fs-3'>
                            Soumettez votre compte à Manager start pour qu'and verifier.
                          </div>
                          ...
                          <button type='submit' className='btn btn-lg btn-primary me-3'>
                            <span className='indicator-label'>
                              {stepper.current?.currentStepIndex !==
                                stepper.current?.totatStepsNumber! - 1 && 'Continuer'}
                              {stepper.current?.currentStepIndex ===
                                stepper.current?.totatStepsNumber! - 1 && 'Nous faire libérer'}
                              <KTSVG
