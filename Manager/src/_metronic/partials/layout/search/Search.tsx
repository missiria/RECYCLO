        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <div
                  ...
                  title='Afficher les préférences de recherche'
                >
                ...
                <div
                  ...
                  title="Afficher plus d'options de recherche "
                >
            ...
            <div ref={suggestionsElement} className='mb-4' data-kt-search-element='main'>
              <div className='d-flex flex-stack fw-bold mb-4'>
                <span className='text-muted fs-6 me-2'>Recherche récente :</span>
              </div>
            ...
            <div ref={emptyElement} data-kt-search-element='empty' className='text-center d-none'>
              ...
              <div className='pb-15 fw-bold'>
                <h3 className='text-gray-600 fs-5 mb-2'>Aucun résultat trouvé</h3>
                <div className='text-muted fs-7'>Veuillez réessayer avec une autre requête</div>
              </div>
            </div>
          </div>

          <form className={`pt-1 ${menuState === 'advanced' ? '' : 'd-none'}`}>
            <h3 className='fw-bold text-dark mb-7'>Recherche Avancée</h3>
            ...
            <div className='mb-5'>
              <select
                name='timezone'
                aria-label='Sélectionnez un fuseau horaire'
          ...
          <form className={`pt-1 ${menuState === 'preferences' ? '' : 'd-none'}`}>
            ...
            <div className='d-flex justify-content-end pt-7'>
              ...
              <button className='btn btn-sm fw-bolder btn-primary'>Entregister</button>
            </div>
          </form>
        </div>
      </div>
