        ...
        <div className='flex-grow-1 card-p pb-0'>
          <div className='d-flex flex-stack flex-wrap'>
            <div className='me-2'>
              ...
              <div className='text-muted fs-7 fw-bold'>Rapports financiers et comptables</div>
            </div>
            <div className={`fw-bolder fs-3 text-${chartColor}`}>24000,00 MAD</div>
          </div>
        </div>
        {/* end::Stats */}
